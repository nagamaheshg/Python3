import random
value = random.random()  # gives range of 0 to 1
print(value)

value = random.uniform(1, 10)  # it gives in range between 1, 10 floating values.
print(value)

value = random.randint(1, 6)  # random value 
print(value)


greetings = ['Hello', 'Hi', 'Hey', 'Howdy', 'Hola'] # return at a time one value
value = random.choice(greetings)
print(value+' '+'Naga Mahesh Gatta')

colors = ['red', 'blue', 'black', 'green']
results = random.choices(colors, k=10) # second arguments number of random items need to pick
print(results)

colors = ['red', 'black', 'green']
results = random.choices(colors, weights=[18,18,2], k=10) # second arguments number of random items need to pick
print(results)
...
# shuffle the values in given range
random.shuffle(deck)
print(deck)

# five random cards that unique cards
